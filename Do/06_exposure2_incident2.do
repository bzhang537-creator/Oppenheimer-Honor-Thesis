...
* Author: Yiqing Zhang
* Date: March 2026
* File: 06_exposure2_incident2.do
* Purpose: DiD - Exposure 2, Incident 2 (Soviet Bomb Test 1949)
********************************************************************************

capture log close
cd "/Users/serendipity/Study abroad/Oppenheimer"
log using "Log/06_exposure2_incident2.log", replace
...
twoway ///
    ...
    xlabel(1946(2)1960) ///
    title("Exposure = 2, Incident 2: Soviet Bomb Test (1949)") ///
    xtitle("Year") ///
    ytitle("Mean Publication Count") ///
    legend(label(1 "Treated") label(2 "Control")) ///
    note("Dotted line = 1949")

graph export "Output/e2_inc2_trends.png", replace
restore
...
esttab e2_inc2_did e2_inc2_pt using "Output/e2_inc2_results.tex", ///
